...
Class EngineLowCost(Engine):
    get_potency
        
Class EngineHIgCost(Engine):
...
""" aqui iria un singletoon para poder hacer un solo catalogo , no lo pude implementar """
